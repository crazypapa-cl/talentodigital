...
var stylos = ['div1','div2','div3','div4']
...
btn.onclick= function(e){
    ...
    if(verdad){
        for(i=0; i<=4; i++){
            ...
            div.setAttribute('style','margin-top:30px;color:black; text-align:left; padding:16px;')
            console.log(stylos[azar])
            div.setAttribute('class',stylos[azar])
